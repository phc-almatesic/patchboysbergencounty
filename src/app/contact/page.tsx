            ...
            <div className="space-y-6">
              <div className="bg-orange rounded-xl p-6 text-white">
                ...
                <a
                  ...
                  className="block bg-white text-orange font-bold py-4 rounded-lg text-center text-lg hover:bg-gray-100 transition-colors"
                >
                  📞 {BUSINESS.phone}
                </a>
              </div>
              ...
              <div className="bg-navy rounded-xl p-6 text-white">
                ...
                <div className="space-y-3 text-sm">
                  <p>
                    ...
                    <a href={`tel:${BUSINESS.phone}`} className="hover:text-orange">{BUSINESS.phone}</a>
                  </p>
                  <p>
              ...
              <div className="bg-gray-warm rounded-xl p-6">
                ...
                <ol className="space-y-3 text-sm text-gray-700">
                  <li className="flex items-start gap-3">
                    <span className="bg-orange text-white w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">1</span>
                    <span>We&apos;ll contact you within 1 business hour to discuss your needs</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="bg-orange text-white w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">2</span>
                    <span>Schedule a convenient time for a free, in-home estimate</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="bg-orange text-white w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">3</span>
