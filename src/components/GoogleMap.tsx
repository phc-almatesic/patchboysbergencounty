...
export default function GoogleMap() {
  ...
  const handleMapInteraction = () => {
    if (!trackedRef.current) {
      ...
      trackEvent("map_interaction", { location: "contact_page" });
    }
  };

  return (
    <div
      className="w-full aspect-[16/9] md:aspect-[21/9] rounded-2xl overflow-hidden border border-gray-200 shadow-sm"
